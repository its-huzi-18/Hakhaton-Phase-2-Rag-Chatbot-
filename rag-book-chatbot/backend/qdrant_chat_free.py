...
def initialize_qdrant_store():
    ...
    # Since we can't include heavy embedding models, we'll use a simpler approach
    # that works with pre-computed embeddings or a different strategy
    # For now, we'll use a mock embedding function that will work within limits
...
def create_rag_chain():
    ...
    This connects the document retriever with a free local LLM
    """
    # Use a lightweight local model that works in Railway's limits
